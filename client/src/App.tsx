...
function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-24 right-4 z-50 flex items-center justify-center w-14 h-14 rounded-full shadow-lg transition-transform hover:scale-110 md:bottom-6 md:right-6"
